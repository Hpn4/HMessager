...
public class ConversationStorage {
    ...
    public Message readMessage() {
        ...
        if (m.getType() != MessageType.TEXT) {
            ...
            m.setData(sm.readAndDecrypt(file, mediaKey));
        }
    ...
    public void storeMessage(Message msg) {
        ...
        if (msg.getType() != MessageType.TEXT) {
            ...
            byte[] tmp = msg.getDataBytes();

            sm.encryptAndSave(tmp, file, key);

            msg.setData(StorageManager.intToByte(mediaCount));
            toCipher = msg.constructByteArray();
            msg.setData(tmp);
        ...
        try {
            ...
            ciphertext = KeyUtils.encrypt(key, toCipher);
        } catch (GeneralSecurityException e) {
