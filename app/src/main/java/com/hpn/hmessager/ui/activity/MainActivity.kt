...
import com.hpn.hmessager.ui.composable.ConfirmPasswordTextField
import com.hpn.hmessager.ui.composable.DialogScreen
import com.hpn.hmessager.ui.composable.PasswordTextField
...
fun DialogFirstScreen(onClick: (String) -> Unit) {
    ...
    DialogScreen(
        ...
        PasswordTextField(
            text = password, onTextChanged = { password = it },
            validateStrengthPassword = true, isGood = isGood
        )

        ConfirmPasswordTextField(text = cPassword, confirmText = password,
