...
public class KeyUtils {
    ...
    // Add BouncyCastle as provider (and remove default android one)
    static {
    ...
    /**
     * Execute DH on the given private key and public key. The public key can be raw data or encoded
     *
     * @param pkey The private key (local)
     * @param publicKey The public key (remote)
     * @param raw If the key is encoded or not
    ...
    private static byte[] diffieHellman(PrivateKey pkey, Key publicKey) throws GeneralSecurityException {
     ...
     * @param info     Additional control data
